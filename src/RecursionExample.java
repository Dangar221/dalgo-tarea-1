...
public class RecursionExample {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Testing of methods of the class RecursiveIntegerLinkedList.");
		System.out.println("If the methods are correctly implemented, the answers of ArrayList and RecursiveIntegerLinkedList must coincide.");
		...
		if(numbersRL.isSorted()) System.out.println("Before sorting, the list is already sorted");
		else System.out.println("Before sorting, the list is not sorted");
		
		//Test divide and conquer methods on unsorted lists
		System.out.println("Testing of methods of the class DivideAndConquerIntegerArrays.");
		System.out.println("If the methods are correctly implemented, the answers of DivideAndConquerIntegerArrays and RecursiveIntegerLinkedList must coincide.");
		...
		int [] segment = divideConquer.maximumIncreasingSegment();
		if(segment!=null) System.out.println("The maximum increasing segment is located between the positions: "+segment[0]+" and "+segment[1]);
		else System.out.println("Null answer for the method maximumIncreasingSegment");
		...
		else if (numbers.contains(value)) System.out.println("Error in method searchUnsorted. The value "+value+" is in the list, but it was not found");
		...
		if(posDC>=0) System.out.println("Position of value "+value+" after sorting. Divide and conquer: "+posDC+". Value in numbers "+numbers.get(posDC));
		segment = divideConquer.maximumIncreasingSegment();
		if(segment!=null && (segment[0]!=0 || segment[1]!=numbers.size()-1)) System.out.println("Error in maximum increasing segment. For sorted arrays the first position should be 0 and the last position should be the size -1");
	}
